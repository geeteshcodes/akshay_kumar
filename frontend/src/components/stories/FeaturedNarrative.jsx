...
export default function FeaturedNarrative() {
  return (
    <section className="bg-sky-100/30 lg:py-32" id="stories" aria-label="Featured narrative">
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12 grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16 items-center">
        <div className="order-2 md:order-1 mb-16 md:mb-0">
          <span className="text-[11px] font-bold tracking-[0.25em] uppercase text-sky-500 mb-4 block">
            THE WEEKLY FEATURE
          </span>
        ...
        <div className="order-1 md:order-2">
          <div className="relative w-full">
            <img
              className="relative z-10 w-full rounded-3xl shadow-[0_24px_60px_-40px_rgba(15,23,42,0.45)] lg:ml-[60px] lg:mt-[32px] object-cover"
