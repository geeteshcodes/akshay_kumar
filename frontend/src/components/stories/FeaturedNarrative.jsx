    ...
    <section className="bg-surface lg:py-32" id="stories" aria-label="Featured narrative">
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12 grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div className="order-2 md:order-1 mb-16 md:mb-0">
          <span className="font-label text-tertiary font-bold tracking-widest text-sm uppercase mb-4 block">
            The Weekly Feature
          </span>
          <h2 className="font-headline text-5xl lg:text-7xl font-black text-on-surface leading-none mb-8">
            The Silence of the Cyclades
          </h2>
          <p className="font-body text-lg lg:text-xl text-on-surface-variant leading-relaxed mb-10 max-w-lg">
          ...
          <Link
            to="#"
            className="inline-flex items-center gap-3 bg-gradient-to-br from-brand to-brand-light text-white px-8 py-4 rounded-lg font-label font-bold transition-transform hover:scale-[1.03]"
            id="read-story-btn"
          >
            Read the Story
        ...
        <div className="order-1 md:order-2">
          <div className="relative w-full">
            <img
              className="relative z-10 w-full rounded-xl shadow-2xl lg:ml-[60px] lg:mt-[32px] object-cover"
